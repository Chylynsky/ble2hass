...
inline int esp_mqtt_client_subscribe(esp_mqtt_client_handle_t client,
    const char* topic, int qos) noexcept
{
    client->dispatch_fut =
...
inline int esp_mqtt_client_unsubscribe(esp_mqtt_client_handle_t client,
